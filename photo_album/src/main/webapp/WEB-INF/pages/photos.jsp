                ...
                <c:if test="${photo.upload.isImage}">
                    ...
                    <div class="more_info">
                        ...
                        <table class="thumbnails">
                            ...
                            <td>
                                <div class="thumbnail_holder">
                                    <cl:image storedSrc="${photo.upload}" extraClasses="thumbnail inline" crop="fit" height="150" width="150" effect="saturation:50" format="jpg"/>
                                </div>
                                <table class="info">
                                    <tr><td>crop</td><td>fit</td></tr>
                                    <tr><td>width</td><td>150</td></tr>
                                    <tr><td>height</td><td>150</td></tr>
                                    <tr><td>effect</td><td>Saturation50</td></tr>
                                </table>
                                <br/>
                            </td>
                            <td>
                                <div class="thumbnail_holder">
                                    <cl:image storedSrc="${photo.upload}" extraClasses="thumbnail inline" overlay="sszia1kcmkha3ws9tzxi" width="100" gravity="south_east" x="5" y="5" opacity="50" effect="brightness:100" format="jpg"/>
                                </div>
                                <table class="info">
                                    <tr><td>crop</td><td>crop</td></tr>
                                    <tr><td>gravity</td><td>south_east</td></tr>
                                    <tr><td>width</td><td>150</td></tr>
                                    <tr><td>height</td><td>150</td></tr>
                                    <tr><td>overlay</td><td>cloudinary_icon</td></tr>
                                </table>
                                <br/>
                            </td>
                        </table>
